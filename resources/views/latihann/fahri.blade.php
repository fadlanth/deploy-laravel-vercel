...
<html lang="id">
  ...
  <body>
    <header>
      <h1>Biodata Saya</h1>
      <p>Perkenalan tentang about me</p>
    </header>

    <section class="biodata">
      <div class="card">
        <img src="biodata/assets/fahri.jpg" alt="Foto Saya" />
        <h2>Fachri</h2>
        <p><strong>Kelas:</strong> XI-PPL2</p>
        <p>Mencoba Sebelum Menyerah</p>
      </div>
    </section>
    ...
    <footer>© 2025 | Dibuat dengan <span>❤</span></footer>
  </body>
</html>
